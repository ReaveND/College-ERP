...
function FacultyCard({ name, designation, department, email }: {
  name: string; designation: string; department: string; email: string;
}) {
  return (
    <div className="bg-white shadow-md rounded-xl p-4 flex flex-col items-center w-64">
      ...
      />
      <h3 className="text-lg font-semibold mt-3 text-blue-950 text-center">{name}</h3>
...
export default function OurFacultyPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Banner */}
      <section className="bg-blue-950 text-white flex flex-col justify-center items-center h-[35vh] text-center px-4">
        <h1 className="text-4xl md:text-5xl font-bold">Vedanta Institute Of Technology</h1>
        <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mt-2">Our Esteemed Faculty</h3>
      ...
      <div className="flex flex-1">
        ...
        {/* Sidebar */}
        <aside className="lg:w-[280px] w-full bg-blue-100 text-blue-950 p-6 sticky top-0 h-fit shadow-md shrink-0">
          {/* <Link href="/" className="text-blue-700 hover:underline text-sm font-medium block mb-5">
            ← Back to Home
          </Link> */}

...
export default function AdmissionPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* Hero Section */}
      <section className="w-full bg-blue-950 text-white py-13 px-6 py-6 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Admissions 2025</h1>
      ...
      <div className="flex flex-col lg:flex-row max-w-8xl mx-auto px-6 lg:px-12 py-12 gap-16">
        ...
        <aside className="hidden lg:block w-64 sticky top-24 h-fit bg-white shadow-md rounded-xl border border-gray-200 p-6 mr-5">
          ...
          <ul className="space-y-3 text-gray-700 text-sm">
            ...
            <li><a href="#eligibility" className="hover:text-yellow-600">Eligibility &amp; Admission</a></li>
        ...
        <main className="flex-1 flex flex-col gap-12">
          ...
          <section id="additional-info" className="bg-white p-8 rounded-2xl shadow-md border-t-4 border-yellow-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              We look forward to welcoming you to Vedanta Institute of Technology, Kolkata! Please ensure all documents
              are correctly prepared to avoid delays. Follow instructions carefully during registration and online
              submission to secure your admission.
            </p>
          </section>

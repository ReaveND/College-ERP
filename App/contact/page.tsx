...
export default function ContactPage() {
  return (
    <div className="contact-page font-sans text-gray-800 min-h-screen">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#162456] to-[#0d183f] text-white py-12 px-6 flex flex-col items-center justify-center text-center">
      ...
      {/* Info Cards */}
      <section className="flex flex-wrap justify-around p-10 bg-gray-100">
        <div className="bg-[#162456] hover:bg-yellow-600 text-white p-6 m-3 flex-1 min-w-[220px] max-w-[250px] rounded-lg shadow-md text-center cursor-pointer transition-all duration-500 hover:scale-105">
      ...
      <section className="mt-8">
        <iframe
          ...
          className="w-full h-96 border-0 shadow-md"
          allowFullScreen
          loading="lazy"

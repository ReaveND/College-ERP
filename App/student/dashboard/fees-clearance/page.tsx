...
const studentData = {
  ...
  payment: { mode: 'Online', transNo: 'pay_KPJljfmvdxLHge', transDate: '21-11-2023', amount: 43250 },
};

export default function FeesClearancePage() {
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 shadow-2xl rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-extrabold text-blue-950">Fees Clearance Document</h1>
          </div>
        ...
        <div className="p-0 md:p-8 flex justify-center">
          <div id="fees-clearance" className="bg-white p-8 border border-gray-400 w-full max-w-4xl text-sm">
            ...
            <h3 className="text-center font-bold underline mb-4">Semester Exam Fees Clearance Document</h3>

...
const studentData = {
  ...
  fee: { receipt: 'order_N3AhtThAfoj5zZ', date: '21-11-2023 20:53:37', amount: '1200', status: 'Paid' },
};
...
export default function ExamFormPage() {
  ...
  const handleDownload = () => {
    ...
    const content = document.getElementById('exam-form')?.innerText ?? '';
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 shadow-2xl rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-extrabold text-blue-950">Exam Form</h1>
          </div>
        ...
        {/* Exam Form Content */}
        <div className="p-0 md:p-8 flex justify-center">
          <div id="exam-form" className="bg-white p-8 border border-gray-400 w-full max-w-4xl text-sm">
            {/* Institute Header */}
            ...
            <div className="mb-4">
              <p><strong>Signature of the Principal / Director of the Institute/College with date and seal.</strong></p>
              <div className="border-b border-gray-600 w-1/2 mt-8"></div>
            </div>
            ...
            <div className="flex justify-between mt-6">
              <button onClick={handleDownload} className="bg-blue-950 text-white px-4 py-2 rounded hover:bg-yellow-600">
                Download
              </button>

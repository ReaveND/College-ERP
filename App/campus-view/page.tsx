  ...
  return (
    <div className="bg-white text-gray-800 min-h-screen">
      ...
      <section className="relative w-full">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-center px-6">
          ...
          <p className="mt-4 text-lg text-gray-200 max-w-2xl">
            A vibrant hub for learning, growth, and innovation, where academics seamlessly meet opportunities.
            Our institute fosters curiosity, creativity, and critical thinking, empowering students to become
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-blue-950 mb-4">Our Beautiful Campus</h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/campusfaculty.jpg" alt="Faculty" className="w-full md:w-1/2 rounded-lg shadow-md object-cover" />
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/library.jpg" alt="Library" className="w-full md:w-1/2 rounded-lg shadow-md object-cover md:order-2 order-1" />
      </section>

      {/* Modern Classrooms */}
      <section className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/campusclassroom.jpg" alt="Classroom" className="w-full md:w-1/2 rounded-lg shadow-md object-cover" />
        <div className="flex flex-col justify-center">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/audito.jpg" alt="Auditorium" className="w-full md:w-1/2 rounded-lg shadow-md object-cover md:order-2 order-1" />
      </section>

      {/* Sports & Activities */}
      <section className="max-w-6xl mx-auto mb-12 px-6 py-16 flex flex-col gap-10 border-t-4 border-t-blue-950 border-b-4 border-b-yellow-600 bg-gray-50 rounded-xl shadow-sm">
        <div className="flex flex-col space-y-4 text-center md:text-left">
          <h4 className="text-lg font-semibold text-yellow-600 uppercase tracking-wide">Beyond Academics</h4>
          <h3 className="text-3xl font-bold text-blue-950">Sports &amp; Activities</h3>
          <p className="text-gray-700 leading-relaxed text-justify">
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-6">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/campusfootball.jpg" alt="Football Ground"
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/campusbasketball.jpg" alt="Basketball Court"
            className="w-full md:w-1/3 h-64 object-cover rounded-lg shadow-lg border-2 border-gray-200 hover:scale-105 transition-transform duration-300" />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/campuspool.jpg" alt="Swimming Pool"
            className="w-full md:w-1/3 h-64 object-cover rounded-lg shadow-lg border-2 border-gray-200 hover:scale-105 transition-transform duration-300" />
        </div>
      </section>

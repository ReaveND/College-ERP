...
import { getStudents, deleteStudent } from '@/lib/adminApi';
                  ...
                  <tr key={data._id} className="border-b font-bold text-center border-blue-800 even:bg-gray-300 odd:bg-gray-400 hover:bg-blue-200">
                    ...
                    <td className="px-4 py-3 text-blue-900">
                      <div className="flex items-center justify-center gap-3">
                        <button onClick={() => router.push(`/admin/dashboard/students/${data._id}/edit`)} className="text-yellow-500 hover:text-yellow-300"><FaEdit size={18} /></button>

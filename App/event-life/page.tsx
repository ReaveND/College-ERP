...
export default function EventLifePage() {
  return (
    <div className="bg-white text-gray-800 min-h-screen">

      {/* Back link */}
      {/* <div className="bg-blue-950 px-6 pt-4 pb-3">
      ...
      <section className="relative w-full h-[60vh]">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-center px-4">
          ...
          <p className="mt-4 text-lg text-gray-200 max-w-2xl">
            ...
            Students enjoy a balanced environment that fosters fun, leadership, and growth.
          </p>
        </div>
      </section>
      ...
      <section id="cultural" className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/cultural.jpg" alt="Cultural Fests" className="w-full md:w-1/2 rounded-lg shadow-md object-cover" />
      ...
      <section id="workshops" className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/workshop.jpg" alt="Workshops" className="w-full md:w-1/2 rounded-lg shadow-md object-cover md:order-2 order-1" />
      </section>

      {/* Seminars & Guest Lectures */}
      <section id="seminars" className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/seminar.jpg" alt="Seminars" className="w-full md:w-1/2 rounded-lg shadow-md object-cover" />
        <div className="flex flex-col justify-center">
      ...
      <section id="sports" className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300">
        <div className="flex flex-col justify-center md:order-1 order-2">
          ...
          <p className="text-gray-700 leading-relaxed">
            Inter-college tournaments, as well as indoor and outdoor sports, provide students with opportunities to compete,
            collaborate, and showcase their talents. Regular fitness activities and sports events encourage a healthy lifestyle
            and build physical endurance. Participating in team sports fosters communication, leadership, and teamwork skills,
            essential for personal and professional growth. Students learn to handle both victories and setbacks gracefully,
            developing resilience and sportsmanship. These activities also create a sense of camaraderie and belonging,
            enhancing the overall campus experience. Through consistent engagement in sports, students cultivate discipline,
            strategic thinking, and a balanced approach to academics and extracurricular pursuits.
          </p>
        </div>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/sports_event.jpg" alt="Sports" className="w-full md:w-1/2 rounded-lg shadow-md object-cover md:order-2 order-1" />
      </section>

      {/* Community Service */}
      <section id="community" className="max-w-6xl mx-auto mb-14 px-6 py-12 flex flex-col md:flex-row gap-8 border-t border-gray-300 border-b-4 border-b-muted-100">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/community.jpg" alt="Community Service" className="w-full md:w-1/2 rounded-lg shadow-md object-cover" />
        <div className="flex flex-col justify-center">
          <h3 className="text-2xl font-bold text-blue-950 mb-2">Community Service</h3>
          <p className="text-gray-700 leading-relaxed">
            Students actively engage in social initiatives, volunteering programs, and community development projects,
            fostering a sense of empathy and compassion. By participating in these activities, they develop leadership skills
            and learn the importance of teamwork and collaboration. Community outreach encourages students to understand
            societal challenges and contribute meaningfully to solutions. These experiences instill social responsibility and
            ethical values that extend beyond the classroom. Through consistent involvement, students cultivate a lifelong
            commitment to service, becoming responsible citizens who positively impact their communities.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-blue-950 text-white px-6 py-10 mt-15">
        <div className="flex justify-center items-start gap-x-20 text-sm flex-wrap gap-y-6">

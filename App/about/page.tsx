...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* Hero Section */}
      <section className="w-full bg-blue-950 text-white py-13 px-6 py-8 text-center">
      ...
      <div className="flex flex-col lg:flex-row max-w-8xl mx-auto px-4 lg:px-5 py-12 gap-4">
        ...
        <main className="flex-1 flex flex-col gap-16">
          ...
          <section id="research" className="bg-white p-8 rounded-2xl shadow-md border-t-4 border-yellow-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              Encouraging students and faculty to explore emerging technologies, publish findings, and collaborate with industries.
              Innovation labs and incubation centers foster entrepreneurship.
            </p>
          </section>
          ...
          <section id="community" className="bg-white p-8 rounded-2xl shadow-md border-t-4 border-yellow-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              Vedanta Institute actively contributes to community development and sustainability projects,
